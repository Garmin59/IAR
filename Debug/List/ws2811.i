#line 1 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
/*
* file ws2811.c
*/
 ...
 * Consult your license regarding permissions and restrictions.
V6.50:0576 */
#line 6 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 7 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
/******************* (C) COPYRIGHT 2012 STMicroelectronics *****END OF FILE****/
#line 8 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 9 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 10 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 11 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 12 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 13 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"
...
#line 14 "D:\\Ilya\\Projects\\332 WS2811 hew year light\\IAR\\project\\ws2811.c"


void init_ws2811_pin (void)
{
  // init pin
	((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBENR |= ((uint32_t)0x00040000);  // разрешаем тактирование GPIOB

	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400))->MODER &= ~((uint32_t)0x00000300);			// PinF4 - input кнопка USER
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400))->OTYPER &= ~((uint32_t)0x00000010);			// PinF4 - pushpull
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400))->OSPEEDR &= ~((uint32_t)0x00000300);	// PinF4 speed low
	((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00001400))->PUPDR |= ((uint32_t)0x00000200);		// PinF4 подтяжка к земле

  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->MODER &= ~((uint32_t)0x000C0000);
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->MODER |= ((uint32_t)0x00080000);        // PinB9 - 10: Alternate function mode
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OTYPER &= ((uint32_t)0x00000200);		      // PinB9 - pushpull
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->OSPEEDR &= ~((uint32_t)0x000C0000);	// PinB9 speed low
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->PUPDR &= ((uint32_t)0x000C0000);          // PinB9 no pullup
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->ODR &= ~((uint32_t)0x00000200);                  // PinB9 = 0
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->AFR[1] &= ~((uint32_t)0x000000F0);
  ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x00000400))->AFR[1] |= 0x02 << (4 * (9 - 8));
  
  // init timer TIM17_CH1
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->APB2ENR |= ((uint32_t)0x00040000);

  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CR1 = ((uint16_t)0x0001)      * 0   //*!<Counter enable */
              | ((uint16_t)0x0002)    * 0   //*!<Update disable */
              | ((uint16_t)0x0004)     * 0   //*!<Update request source */
              | ((uint16_t)0x0008)     * 0   //*!<One pulse mode */
              | ((uint16_t)0x0080)    * 0   //*!<Auto-reload preload enable */
              | ((uint16_t)0x0100)   * 0   //*!<Bit 0 */
              | ((uint16_t)0x0200)   * 0;  //
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CR2 = ((uint16_t)0x0001)     * 0   //*!<Capture/Compare Preloaded Control */
              | ((uint16_t)0x0004)    * 0   //*!<Capture/Compare Control Update Selection */
              | ((uint16_t)0x0008)    * 0   //*!<Capture/Compare DMA Selection */
              | ((uint16_t)0x0100)    * 0   //*!<Output Idle state 1 (OC1 output) */
              | ((uint16_t)0x0200)   * 0;  //*!<Output Idle state 1 (OC1N output) */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->DIER = ((uint16_t)0x0001)    * 0   //*!<Update interrupt enable */
              | ((uint16_t)0x0002)  * 0   //*!<Capture/Compare 1 interrupt enable */
              | ((uint16_t)0x0020)  * 0   //*!<COM interrupt enable */
              | ((uint16_t)0x0080)    * 0   //*!<Break interrupt enable */
              | ((uint16_t)0x0100)    * 0   //*!<Update DMA request enable */
              | ((uint16_t)0x0200)  * 1;   //*!<Capture/Compare 1 DMA request enable */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->SR = 0;  //*!< TIM status register, */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->EGR = 0; //*!< TIM event generation register, */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CCMR1 = ((uint16_t)0x0001) * 0   //*!<Bit 0 00: CC1 channel is configured as output*/
              | ((uint16_t)0x0002)  * 0   //*!<Bit 1 */
              | ((uint16_t)0x0004)   * 1   //*!<Output Compare 1 Fast enable */
              | ((uint16_t)0x0008)   * 1   //*!<Output Compare 1 Preload enable */
              | ((uint16_t)0x0010)  * 0   //*!<Bit 0 (Output Compare 1 Mode)*/
              | ((uint16_t)0x0020)  * 1   //*!<Bit 1 110: PWM mode 1*/
              | ((uint16_t)0x0040)  * 1;  //*!<Bit 2 */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CCER = ((uint16_t)0x0001)     * 1   //*!<Capture/Compare 1 output enable */
              | ((uint16_t)0x0002)     * 0   //*!<Capture/Compare 1 output Polarity 0: OC1 active high*/
              | ((uint16_t)0x0004)    * 0   //*!<Capture/Compare 1 Complementary output enable */
              | ((uint16_t)0x0008)    * 0;   //*!<Capture/Compare 1 Complementary output Polarity */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CNT = 0;           //*!< TIM counter register */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->PSC = 2;           //*!< TIM prescaler register,
                            // The counter clock frequency (CK_CNT) is equal to fCK_PSC / (PSC[15:0] + 1)*/
  
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->ARR = 21;  //*!< TIM auto-reload register */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->RCR = 0;           //*!< TIM  repetition counter register, */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CCR1 = 18; //*!< TIM capture/compare register 1,  */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->BDTR = ((uint16_t)0x0001)  * 0   //*!<Bit 0 */
              | ((uint16_t)0x0002)  * 0   //*!<Bit 1 */
              | ((uint16_t)0x0004)  * 0   //*!<Bit 2 */
              | ((uint16_t)0x0008)  * 0   //*!<Bit 3 */
              | ((uint16_t)0x0010)  * 0   //*!<Bit 4 */
              | ((uint16_t)0x0020)  * 0   //*!<Bit 5 */
              | ((uint16_t)0x0040)  * 0   //*!<Bit 6 */
              | ((uint16_t)0x0080)  * 0   //*!<Bit 7 */
              | ((uint16_t)0x0100) * 0   //*!<Bit 0 */
              | ((uint16_t)0x0200) * 0   //*!<Bit 1 */
              | ((uint16_t)0x0400)   * 0   //*!<Off-State Selection for Idle mode */
              | ((uint16_t)0x0800)   * 0   //*!<Off-State Selection for Run mode */
              | ((uint16_t)0x1000)    * 0   //*!<Break enable */
              | ((uint16_t)0x2000)    * 0   //*!<Break Polarity */
              | ((uint16_t)0x4000)    * 0   //*!<Automatic Output enable */
              | ((uint16_t)0x8000)    * 1;  //*!<Main Output enable */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->DCR = ((uint16_t)0x0001)  * 0   //*!<Bit 0 */
              | ((uint16_t)0x0002) * 0   //*!<Bit 1 */
              | ((uint16_t)0x0004) * 0   //*!<Bit 2 */
              | ((uint16_t)0x0008) * 0   //*!<Bit 3 */
              | ((uint16_t)0x0010) * 0   //*!<Bit 4 */
              | ((uint16_t)0x0100) * 0   //*!<Bit 0 */
              | ((uint16_t)0x0200) * 0   //*!<Bit 1 */
              | ((uint16_t)0x0400) * 0   //*!<Bit 2 */
              | ((uint16_t)0x0800) * 0   //*!<Bit 3 */
              | ((uint16_t)0x1000) * 0;  //*!<Bit 4 */
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->DMAR = 0;            /*!< TIM DMA address for full transfer register,*/
  ...
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CR1 |= ((uint16_t)0x0001);
...
void led_buffer_clear (void)
{
  memset (g.led_buffer, 5, (50 * 24));
  for (u16 *p_buffer = g.led_buffer; p_buffer < &g.led_buffer[(50 * 24)]; p_buffer++)
  {
    *p_buffer = 5;
  }
}
...
void led_buffer_set (color_t *stripe)
{
  ...
  *p_buffer = 0;  // формирование сброса "0" для следующего блока данных
...
void led_dma_init (void)
{
  ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->AHBENR |= ((uint32_t)0x00000001);
  
  ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->IFCR = 0xFFFFFFFF;
  
  ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CCR = ((uint32_t)0x00000001)     * 0 //*!< Channel enable                      */
                    | ((uint32_t)0x00000002)    * 1 //*!< Transfer complete interrupt enable  */
                    | ((uint32_t)0x00000004)    * 0 //*!< Half Transfer interrupt enable      */
                    | ((uint32_t)0x00000008)    * 0 //*!< Transfer error interrupt enable     */
                    | ((uint32_t)0x00000010)     * 1 //*!< Data transfer direction 1: Read from memory*/
                    | ((uint32_t)0x00000020)    * 0 //*!< Circular mode                       */
                    | ((uint32_t)0x00000040)    * 0 //*!< Peripheral increment mode           */
                    | ((uint32_t)0x00000080)    * 1 //*!< Memory increment mode               */
                    | ((uint32_t)0x00000100) * 1 //*!< Bit 0  PSIZE[1:0] bits              */
                    | ((uint32_t)0x00000200) * 0 //*!< Bit 1 01: 16-bits                    */
                    | ((uint32_t)0x00000400) * 1 //*!< Bit 0 MSIZE[1:0] bits               */
                    | ((uint32_t)0x00000800) * 0 //*!< Bit 1 01: 16-bits                    */
                    | ((uint32_t)0x00001000)    * 1 //*!< Bit 0 PL[1:0] bits                  */
                    | ((uint32_t)0x00002000)    * 1 //*!< Bit 1 11: Very high                 */
                    | ((uint32_t)0x00004000) * 0; //*!< Memory to memory mode              */
  ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CNDTR = (50 * 24) + 1;
  ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CPAR = (u32)&((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->CCR1 + 1;
  ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CMAR = (u32)g.led_buffer;
  ...
  ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CCR |= ((uint32_t)0x00000001); //*!< Channel enable     
}

#pragma call_graph_root="interrupt"         // interrupt category
void DMA1_Channel1_IRQHandler (void)
{
  if (((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->ISR & ((uint32_t)0x00000002))
  {
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->DIER = 0;
    ((DMA_Channel_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x00000000) + 0x00000008))->CCR &= ~((uint32_t)0x00000001); //*!< Channel disable 
  }
  ((DMA_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000000))->IFCR = ((uint32_t)0x00000001)   * 1 /*!< Channel 1 Global interrupt clear    */
              | ((uint32_t)0x00000002) * 1 /*!< Channel 1 Transfer Complete clear   */
              | ((uint32_t)0x00000004) * 1 /*!< Channel 1 Half Transfer clear       */
              | ((uint32_t)0x00000008) * 1;/*!< Channel 1 Transfer Error clear      */
}
...
void led_buffer_proc (void)
{
  ...
  if (timer_end (&led_buffer_timer, 20))  // 50 раз в секунду
  {
    ...
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00014800))->DIER |= ((uint16_t)0x0200);
